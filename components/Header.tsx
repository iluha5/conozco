        ...
        <>
            <header className="border-b bg-white">
                <div
                    ...
                    className="container mx-auto px-4 py-3 flex items-center justify-between md:justify-start"
                >
                    ...
                    <nav className="hidden md:flex items-center gap-4">
                        <Link
                            href="/words"
                            className="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-gray-900 relative pb-1.5 group"
                        >
