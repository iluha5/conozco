...
export function getTrainingModeConfig(
    ...
    if (!found && (modeId.startsWith('learned-test-es-') || modeId.startsWith('learned-test-en-'))) {
        ...
        if (testConfig) {
            ...
            found = {
                ...
                title: testConfig.difficulty === 'easy' ? t('Test A1 (easy)') : t('Test A1 (medium)'),
                shortDescription: testConfig.difficulty === 'easy' ? t('10 random words from A1') : t('20 random words from A1'),
