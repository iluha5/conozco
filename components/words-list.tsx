...
export function WordsList({
    ...
    const [translationSelectorOpen, setTranslationSelectorOpen] = useState<{
        [key: string | number]: boolean;
    }>({});
    const [translationSelectorPosition, setTranslationSelectorPosition] =
        useState<{ [key: string | number]: { top: number; left: number } }>({});
                                                ...
                                                translationSelectorPosition[
                                                    ...
                                                    >
                                                        ...
                                                        <div className="space-y-1">
                                                            ...
                                                            {word.baseWord?.translations.map(
                                                                (
                                                                    translation,
                                                                    index,
                                                                ) => (
