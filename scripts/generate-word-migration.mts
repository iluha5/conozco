...
export function generateMigrationSQL(
    ...
    if (translationBatches.length > 0) {
        ...
        const translationsByWord = new Map<string, typeof translationBatches>();
        ...
        const batches: (typeof translationBatches)[] = [];
        let currentBatch: typeof translationBatches = [];
    ...
    if (exampleBatches.length > 0) {
        ...
        const examplesByWordPronoun = new Map<string, typeof exampleBatches>();
        exampleBatches.forEach(e => {
        ...
        const exampleBatchesArray: (typeof exampleBatches)[] = [];
        let currentExampleBatch: typeof exampleBatches = [];
    ...
    if (grammaticalExampleBatches.length > 0) {
        ...
        const grammaticalExamplesByKey = new Map<
            string,
            typeof grammaticalExampleBatches
        >();
        grammaticalExampleBatches.forEach(ge => {
        ...
        const grammaticalBatchesArray: (typeof grammaticalExampleBatches)[] =
            [];
        let currentGrammaticalBatch: typeof grammaticalExampleBatches = [];
