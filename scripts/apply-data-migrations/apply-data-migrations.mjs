 ...
 */
async function readMigrationMetadata(migrationDir) {
 ...
 */
function getMigrationName(migrationDir) {
    return path.basename(migrationDir);
}
/**
 * Apply a single migration
 */
async function applyMigration(migrationDir, metadata, gitSha, appliedBy) {
